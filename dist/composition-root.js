...
const likesQueryRepository = new likes_query_repository_1.LikesQueryRepository();
const likesRepository = new likes_repository_1.LikesRepository();
const likesService = new likes_service_1.LikesService(likesRepository);
...
const postsQueryRepository = new posts_query_repository_1.PostsQueryRepository(likesQueryRepository);
...
const commentsQueryRepository = new comments_query_repository_1.CommentsQueryRepository(likesQueryRepository);
...
exports.commentsController = new commentsController_1.CommentsController(commentsService, likesService, commentsQueryRepository, postsQueryRepository);
exports.postsController = new postsController_1.PostsController(postsService, likesService, postsQueryRepository, exports.blogsQueryRepository);
