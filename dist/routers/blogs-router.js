...
exports.blogsRouter.get('/:blogId/posts', postsController_1.postsController.findPostsOfBlogController.bind(composition_root_1.blogsController));
exports.blogsRouter.post('/:blogId/posts', authMiddleware_1.authMiddleware, postsInputValidation_1.postsInputValidation, inputValidationMiddleware_1.inputValidationMiddleware, postsController_1.postsController.createPostForBlogController.bind(composition_root_1.blogsController));
